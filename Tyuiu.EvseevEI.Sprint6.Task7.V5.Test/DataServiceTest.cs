...
namespace Tyuiu.EvseevEI.Sprint6.Task7.V5.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        {
            string path = @"C:\Users\evseevegor709icloud\source\repos\Tyuiu.EvseevEI.Sprint6\Tyuiu.EvseevEI.Sprint6.Task7.V5\InPutDataFileTask7V5.csv";
